 ...
 * @param {String} [proxy] URL of an HTTP proxy to be used: causes strict SSL
*      certificate verification to be disabled!
 */
function AuthToken(region, accessKey, secretKey, tenant, proxy) {
...
AuthToken.prototype._authImpl = function(callback) {
  ...
  transport.POST(uri, null, options, function(err, response, body) {
    ...
    self.tenant = body.access.token.tenant;
